...
namespace lab2
{
    internal class Methods
    {
        ...
        public static void GetApartmentsByFloorAreaAsc(XDocument doc)
        {
            var query = from apartment in doc.Root.Descendants("Apartments")
                        where int.Parse(apartment.Element("Floor").Value) >= 5
                        orderby int.Parse(apartment.Element("Area").Value) ascending
                        select Apartment.Parse(apartment);                  
        ...
        public static void GetApartmentsByAreaFloorDesc(List<Apartment> apartments)
        {
        ...
        public static void GroupApartmentsByFloorCount(List<Apartment> apartments)
        {
        ...
        public static void GroupApartmentsByFloorAvgArea(List<Apartment> apartments)
        {
            var query = apartments
        ...
        public static void GetRealtorsByPhoneNumber(List<Realtor> realtors)
        {
            var query = realtors
        ...
        public static void GetApartmentsByAreaFloor(List<Apartment> apartments)
        {
            var query = from apartment in apartments
        ...
        public static void GetApartmentsByFloorAreaDesc(List<Apartment> apartments)
        {
            var query = apartments
        ...
        public static void GroupApartmentsByFloorGr4AvgArea(List<Apartment> apartments)
        {
            var query = from apartment in apartments
        ...
        public static void GetRealtorsByNameAOrB(List<Realtor> realtors)
        {
            var query = realtors
        ...
        public static void GetApartmentsByPrice(List<Apartment> apartments, List<Apartments_RealEstateAgencies> apartmentAgencies)
        {
            var query = from apartment in apartments
        ...
        public static void GroupApartmentsByFloorSumAreaFloorLess3(List<Apartment> apartments)
        {
            var query = from apartment in apartments
        ...
        public static void GetApartmentsByAreaPrice(List<Apartment> apartments, List<Apartments_RealEstateAgencies> apartmentAgencies)
        {
            var query = from apartment in apartments
                        join apartmentAgency in apartmentAgencies on apartment.ApartmentsID equals apartmentAgency.ApartmentsID
        ...
        public static void GetRealtorsWithNamePhoneNumber(List<Realtor> realtors)
        {
        ...
        public static void GetUnsoldApartments(List<Apartment> apartments, List<Apartments_RealEstateAgencies> apartmentAgencies)
        {
            var query = from apartment in apartments
        ...
        public static void GetAllApartments(List<Apartment> apartments)
        {
            var query = from apartment in apartments
                        select apartment;
        ...
        // 21. Get all realtors
        public static void GetAllRealtors(List<Realtor> realtors)
        {
